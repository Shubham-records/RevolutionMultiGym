...
export default function Page9() {
  ...
  const ListCarusal = [
    ...
    },
    {
      ...
      review:
        "I have been to so many gyms, across India, but TBH, no other gym provides women with such professional approach like Revolution multi gym does. The trainers here are very cooperative and so are other members. You won't regret joining this gym, I assure.",
    },
    {
      name: "Samuel Paul",
      date: "2 months ago",
      ...
      review:
        "We'll maintained equipments.... Good trainers... Affordable fee, you'll enjoy your workouts....",
    },
    {
      ...
      review:
        "Great gym. The trainers are well trained and they help you with your body goal.",
    },
    {
      name: "smruti sswain",
      date: "3 months ago",
      ...
      review:
        "It's a place where you can find a best range of equipments (enough for a fully functional gym) & Trainers are good & supportive.I like to recommend my friends,If you're searching for the top gym in Baripada ,then revolution is one of your best choice👌🏻 …",
    },
    {
    ...
    },
    {
      ...
      review:
        "They protize women privacy, well trained trainers, varatiy of equipments, they help me to lose weight 6kg in 2 months period, thank you revolution gym",
    },
  ];
  ...
  return (
    <section
      className="page9"
      style={{ backgroundColor: "#fff", padding: "1rem 0" }}
    >
      <div>
          ...
          <span style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
            <div className="rating-container">
              ...
              <span style={{ alignItems: "center", display: "flex" }}>
                <div className="rating-text" style={{ color: "#d97707" }}>
                  5.0
                </div>
            ...
            <div className="Review_container">
              ...
              <p style={{ fontWeight: 500 }} className="reviews-link">
                Based on <strong style={{ fontWeight: "bold" }}>512</strong>{" "}
                reviews
              </p>
            </div>
          </span>
          <div>
            ...
            >
              <a
                ...
                href="https://www.google.co.in/maps/place/Revolution+Multi+Gym,+Baripada/@21.9334423,86.726175,17z/data=!4m8!3m7!1s0x3a1db1ed6ecec1d9:0xb333e0ed91f2a20b!8m2!3d21.932681!4d86.7231251!9m1!1b1!16s%2Fg%2F11bwkb3j5f?entry=ttu"
                target="_blank"
        ...
        <div className="mobilegoogle-rating">
            <span style={{ alignItems: "center", display: "flex" }}>
              <img style={{ height: "2rem" }} src={GoogleLogo} />
              <div className="google">Excellent</div>
            </span>
            <span style={{ alignItems: "center", display: "flex" }}>
              <div className="rating-text" style={{ color: "#000" }}>
                5.0
              </div>
              <p style={{ color: "#fabd05", margin: 0, fontSize: "20px" }}>
                &#9733;&#9733;&#9733;&#9733;&#9733;
      ...
      <div className="carusalcard" style={{ padding: "0rem 10vw" }}>
        <Slider {...settings}>
          {ListCarusal.map((googlereviews) => (
            <div
              className={
                readMoreStates[googlereviews.name]
                  ? "conditionedCard"
                  : "unconditionedCard"
              }
              style={{ width: "90%" }}
              key={googlereviews.name}
            >
              <span
                style={{
                  alignItems: "center",
              ...
              <div className="review">
                <p
                  style={{
                    WebkitLineClamp: readMoreStates[googlereviews.name]
                      ? "unset"
                      : "3",
      ...
      <div className="carusalcardmobile">
